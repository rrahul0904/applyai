...
type Question = { id: string; title: string; track: string; difficulty: string; published: boolean; frequency_score: number; confidence: number; report_count: number; companies: string[]; stages: string[] };
