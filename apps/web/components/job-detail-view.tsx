      ...
      <div className="detail-main">
        <Card className="detail-hero">
          <div className="detail-title-row">
            ...
            <div>
              <p className="eyebrow">{item.data_origin === "DEVELOPMENT_SEED" ? "Development data" : "Job opportunity"}</p>
              <h1>{item.title}</h1>
      ...
      <aside className="detail-aside">
        <Card className="sticky-actions">
          ...
          <div className="facts-list">
            ...
            <div className="fact-row"><CalendarDays size={17} /><div><strong>Last verified</strong><span>{formatDate(item.last_seen_at)}</span></div></div>
          </div>
