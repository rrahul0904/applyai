...
JOB_RADAR_TASK_TYPES = {"JOB_RADAR_SCAN"}
SOURCE_TASK_TYPES = {"JOB_URL_IMPORT", "SOURCE_DISCOVERY", "SOURCE_INGEST", "SOURCE_VERIFY"}
AI_TASK_TYPES = {
    "AI_DEEP_MATCH",
    "AI_RESUME_TAILOR",
...
KNOWN_TASK_TYPES = RESUME_TASK_TYPES | JOB_RADAR_TASK_TYPES | SPECIAL_TASK_TYPES
