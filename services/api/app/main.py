...
from app.api import (
    ...
    interview_media, job_imports, jobs, me, onboarding, privacy, profiles, recruiter_lens, resume_shares,
    resumes, semantic_matching,
)
...
for product_router in (candidate_workspace.router,career_product_contract.router,career_product_polish.router,career_product.router,career_prepare.router,application_materials.router,interview_media.router,career_system.router,recruiter_lens.router,resume_shares.router,agents.router,application_agent.router,application_agent_documents.router): app.include_router(product_router,prefix="/api/v1",include_in_schema=False)
