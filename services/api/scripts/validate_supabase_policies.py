...
def validate_policy_sql(sql: str) -> dict[str, object]:
    ...
    required_fragments = {
        ...
        "global_public_function_revoke": "revoke execute on all functions in schema public from anon, authenticated",
        ...
        "future_function_grant_lockdown": "revoke execute on functions from anon, authenticated",
